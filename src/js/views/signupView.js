  ...
  _generateMarkup() {
    ...
    <section class="form__section">
      ...
      <div class="form__container form__container--blur">
        ...
        ${this.FORM('Sign up', defaultUserPic, 'block')}
      </div>
    </section>`
  }

  FORM(buttonText, formPic, showLoginBtn) {
    return `
      ...
      <div class="signup__form__profile">
        ...
        <p style='display:${showLoginBtn}' class="signup--login">Already have a account?<a href="/">Log In</a></p>
      </form>
    `
  }
